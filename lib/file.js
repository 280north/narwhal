...
exports.join = function () {
    return exports.normal(Array.prototype.join.apply(arguments, [exports.SEPARATOR]));
};
...
exports.dirname = function (path) {
    return exports.resolve(path, exports.SELF);
};
...
exports.extname = function(path) {
    ...
    var index = path.lastIndexOf(exports.SELF);
