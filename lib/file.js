...
Path.prototype.extname = function () {
    return exports.extname(this.path);
};

Path.prototype.exists = function () {
    return exports.exists(this.path);
};
...
Path.prototype.read = function () {
    return exports.read(this.path);
};

Path.prototype.list = function () {
    return implementation.list(this.path);
};

Path.prototype.mkdir = function() {
    return exports.mkdir(this.path);
}

Path.prototype.mkdirs = function() {
    return exports.mkdirs(this.path);
}

Path.prototype.rmdir = function() {
    return exports.rmdir(this.path);
}

Path.prototype.rmtree = function() {
    return exports.rmtree(this.path);
}
