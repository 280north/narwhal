...
exports.Sandbox = function (options) {
    ...
    var sandbox = function (id, baseId, force, reload, pkg, basePkg) {
        ...
        if (!Object.prototype.hasOwnProperty.call(modules, id) || force) {
            ...
            var require = Require(id, null, pkg);
            var module = metadata[id] = metadata[id] || {};
            module.id = id;
            module.path = factory.path;
            if(pkg) {
                module["package"] = pkg;
                module["using"] = ((pkg && loader.usingCatalog && loader.usingCatalog[pkg])?
    ...
    var Require = function (baseId, fileName, basePkg) { // XXX deprecated fileName
        var require = function (id, pkg) {
            //try {
                return sandbox(id, baseId, false, false, pkg, basePkg);
            //} catch (exception) {
