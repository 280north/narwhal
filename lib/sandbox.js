...
exports.Sandbox = function (options) {
    ...
    var sandbox = function (id, baseId, pkg, basePkg, options) {
        ...
        if (!Object.prototype.hasOwnProperty.call(modules, id) || options.force || options.once) {
            ...
            if (options.once) {
                ...
                if (!Object.prototype.hasOwnProperty.call(modules, id) || options.reload)
                    exports = modules[id] = {};
                exports = modules[id];
            }
            ...
            */
            ...
            exports = modules[id];
            if (metadata[id]) {
                metadata[id].setExports = function () {
