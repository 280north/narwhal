...
exports.Sandbox = function (options) {
    ...
    var sandbox = function (id, baseId, force, reload) {
        ...
        for (var name in exports) {
            try {
<<<<<<< HEAD:lib/sandbox.js
            	// This try/catch block is needed to handle wrapped Java objects
            	// in Rhino.
            	curryUsed = typeof exports[name] == "function" && exports[name].xNarwhalCurryId;
            } catch (e) {};
...
=======
            ...
            if (curryUsed) { 
>>>>>>> 3ba9b668970de21270db298ed44853835bb35dd0:lib/sandbox.js
                importsUsed = true;
