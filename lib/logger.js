...
Logger.prototype.fatal = function() {
    return this.add(Logger.FATAL, this.format(Logger.DEBUG, arguments));
}
Logger.prototype.error = function() {
    return this.add(Logger.ERROR, this.format(Logger.DEBUG, arguments));
}
Logger.prototype.warn = function() {
    return this.add(Logger.WARN, this.format(Logger.DEBUG, arguments));
}
Logger.prototype.info = function() {
    return this.add(Logger.INFO, this.format(Logger.DEBUG, arguments));
}
...
Logger.prototype.add = function(severity, message, progname) {
    ...
    this.output.puts(message || progname);
}
