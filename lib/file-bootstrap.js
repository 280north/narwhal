...
// defaults to be overridden by file module or bootstrapper
exports.ROOT = "/";
exports.SEPARATOR = "/";
...
exports.split = function (path) {
    var parts;
    try {
        parts =  String(path).split(SEPARATORS_RE);
    } catch (exception) {
...
exports.resolve = function () {
    ...
    for (var i = 0; i < arguments.length; i++) {
        ...
        if (exports.isAbsolute(path)) {
            path = parts.slice(1);
            root = parts[0] + exports.SEPARATOR;
            parents = [];
            children = [];
        }
        leaf = parts.pop();
...
exports.basename = function (path, extension) {
    var basename = path.split(exports.SEPARATOR).pop();
    if (extension)
