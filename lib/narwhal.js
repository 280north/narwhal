...
parser.option('-p', '--print', 'print')
    .help("print the result of evaluated commands")
    .set(true);

parser.option('-n', '--input', 'input')
    .help("evaluate commands on each line of input as '_'")
    .set(true);

parser.option('-N', '--input-all', 'inputAll')
    .help("evaluate commands on entire input as '_'")
    .set(true);

parser.option('-j', '--json-out', 'jsonOutput')
    .help("write output as JSON")
    .set(true);

parser.option('-J', '--json-in', 'jsonInput')
