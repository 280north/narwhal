...
function boot() {
    ...
    // global public API for getting a promise that will be fulfilled when the
    // requested module is ready to be loaded, which entails the registration
    // of that module's transitive dependencies.
    ...
    // global public API: request that a module be loaded whenever it is ready.
