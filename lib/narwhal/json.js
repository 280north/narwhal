...
parser.option('-e', '--execute', 'statement', 'execute')
    .todo('execute', 'statement')
    .help('execute a statement');
parser.option('-x', '--evaluate', 'expression', 'evaluate')
...
parser.option('-p', '--print-lines', 'print').set('lines');
parser.option('-P', '--print-all', 'print').set('all');
...
actions.mode = function (_, options, value) {
    options.read = value;
    return _;
};
