...
exports.run = function(objectOrModule) {
    ...
    do {
        var result = exports._run(objectOrModule, options);
    } while (options.loop);
    
    return result;
}

exports._run = function(objectOrModule, options, context) {
    ...
    for (var property in objectOrModule) {
        if (property.match(/^test/)) {
            ...
            if (typeof objectOrModule[property] == "function") {
                ...
                exports._run(objectOrModule[property], options, localContext);
            }
        }
    }
