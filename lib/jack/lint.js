...
Lint.prototype.invoke = function(env) {
    if (!env)
...
Lint.prototype.each = function(block) {
...
Lint.prototype.close = function() {
    if (this.body.close)
        return this.body.close();
}

Lint.prototype.check_env = function(env) {
...
Lint.prototype.check_input = function(input) {
    // FIXME:
...
Lint.prototype.check_error = function(error) {
...
Lint.prototype.check_status = function(status) {
    if (!(parseInt(status) >= 100))
        throw new Error("Status must be >=100 seen as integer");
}
Lint.prototype.check_headers = function(headers) {
...
Lint.prototype.check_content_type = function(status, headers) {
...
Lint.prototype.check_content_length = function(status, headers, env) {
